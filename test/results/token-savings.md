Measured on 2026-05-13. Tokenizer counts use js-tiktoken (cl100k_base) and are the source of truth; proxy counts are a fair char-weighted estimate for offline runs.
